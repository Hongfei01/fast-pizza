    ...
    <div>
      ...
      <Form method="POST">
        ...
        <div>
          ...
          <div>
            <input
              className="transaction-all w-full rounded-full border border-stone-200 px-4 py-2 text-sm placeholder:text-stone-400 focus:outline-none focus:ring focus:ring-yellow-400 md:px-6 md:py-3"
              type="text"
              name="address"
              required
            />
        ...
        <div>
          ...
          >
            {isLoading ? 'Placing a order' : 'Order now'}
          </button>
        </div>
      </Form>
    </div>
